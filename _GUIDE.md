...
> [!NOTE]
> Click the **Home** icon in your tab bar or open the `Home.base` file to see your content in a grid view.

## Key workflows

- **Writing**: just use `Ctrl/Cmd + N` to create a new file using your default content type and start writing.
